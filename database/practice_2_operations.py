...
def get_practice2_data_data_race_year(country: str, year: int) -> pd.DataFrame:
...
def get_drivers_per_year_from_practice2_data(year: int) -> pd.DataFrame:
...
def get_driver_results_per_year_practice2_data(year: int, driver: str) -> pd.DataFrame:
...
# print(get_all_practice2_data())
# print(get_practice2_data_data_race_year('Austria', 2023))
# print(get_drivers_per_year_from_practice2_data(2022))
# print(get_driver_results_per_year_practice2_data(2024, 'Max Verstappen VER'))